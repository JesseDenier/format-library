...
const ModelAccessRoute = () => {
  ...
  // If user does NOT have access to the model inform the user they must pay to access it
  if (!user.modelAccess) {
    return (
          ...
          <div className="shadow-md rounded-lg p-8">
            <div className="card-body text-center">
              <p className="text-center mb-4">
                You do not have access to the Model. Use the link below to
                purchase the Model.
              </p>
              <a
                // Link updated 10/16/24.
                href="https://isca18.wildapricot.org/event-4857482 "
              ...
              <p className="text-center mt-6 mb-4">
                ...
                Model use the link below to contact ISCA.
              </p>

              <a
                href={`mailto:adminsupport@iscainfo.com?subject=ISCA%20Model%20Access%20Issue&body=I%20purchased%20the%20e-Book%20or%20digital%20version%20of%20the%20ISCA%20International%20Model%202nd%20Edition,%20but%20I%20do%20not%20have%20access%20to%20the%20Model%20on%20the%20ISCA%20publications%20site.%0A%0AMy%20name%20is%20${user.firstName}%20${user.lastName},%20and%20the%20email%20I%20purchased%20it%20with%20is%20${user.email}.%0A%0AThank%20you.`}
                className="w-full font-bold py-2 px-4 rounded shadow-md bg-[#bfd9d9] hover:bg-[#006666] hover:text-white"
              >
                Contact ISCA
              </a>
...
export default ModelAccessRoute;
