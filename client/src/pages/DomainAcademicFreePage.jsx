    ...
    <main className="flex flex-col min-h-screen px-4 mx-auto pt-20">
      ...
      <div className="text-center mb-4 w-3/4 mx-auto">
        <h2 className="text-xl font-semibold">
          Welcome to your free access to the Academic Domain of the ISCA Student
          Standards Learning Progression!
          <br />
          You can purchase the complete Learning Progression, which includes all
          four domains,
          <a
            // Link updated 10/2/24.
            href="https://iscainfo.com/event-5899708"
      ...
      <div className="flex-none">
        <div className="text-center pb-4 space-y-2 sm:space-y-0">
          ...
          <button
            onClick={() =>
              handlePDFWatermarkAndDownload(
                "/private/domain_academic_free.pdf",
                user,
          ...
          <button
            onClick={() =>
              handlePDFWatermarkAndDownload(
                "/private/domain_academic_free_p.pdf",
                user,
                "ISCA Academic Domain Print"
              )
            }
            className="bg-[#026666] hover:bg-[#9acdc0] text-white font-bold py-2 px-4 mx-2 rounded"
          >
...
export default DomainAcademicFreePage;
